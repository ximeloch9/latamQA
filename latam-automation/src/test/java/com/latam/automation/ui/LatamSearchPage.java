...
public class LatamSearchPage {
        ...
        public static final Target ORIGIN_AUTOCOMPLETE_OPTION = Target.the("Primera opcion de autocompletado de origen")
                        .located(By.cssSelector(
                                        "[data-testid*='origin--autocomplete'] [data-testid*='autocomplete__listitem']"));

        public static final Target DESTINATION_AUTOCOMPLETE_OPTION = Target
                        .the("Primera opcion de autocompletado de destino")
                        .located(By.cssSelector(
                                        "[data-testid*='destination--autocomplete'] [data-testid*='autocomplete__listitem']"));
        ...
        public static final Target REGIONAL_CONTINUE_BUTTON = Target
                        .the("Boton continuar selector regional de idioma/pais")
                        .located(By.id("country-lang-selector-continue-button"));

        public static final Target REGIONAL_CANCEL_BUTTON = Target
                        .the("Boton cancelar selector regional de idioma/pais")
        ...
        public static final Target GENERIC_DIALOG_CLOSE_BUTTON = Target
                        .the("Boton generico de cierre de dialogo o modal")
                        .located(By.cssSelector(
                                        "button[class*='close'], [class*='CloseButton'], [data-testid*='close'], [aria-label='Close'], [aria-label*='cerrar'], [aria-label*='Cerrar'], .dialog__close-button"));
        ...
        public static final Target NEXT_MONTH_BUTTON = Target.the("Boton siguiente mes del calendario")
                        .located(By.xpath(
                                        "//button[contains(@data-testid, 'calendar-next-month-button') or contains(@class, 'next-month') or contains(@aria-label, 'Siguiente mes') or @data-testid='calendar-navigation-button-next']"));
        ...
        public static final Target ADULT_PASSENGERS_ADD = Target.the("Boton agregar adulto")
                        .located(By.xpath(
                                        "//button[contains(@data-testid, 'add-passenger-adult') or contains(@id, 'add-passenger-adult')]"));
